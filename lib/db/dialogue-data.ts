...
// ── Scene 1: Selamat Pagi! (Good Morning!) ──────────────────────────
// Merged from scene1a (greetings) + scene1b (introductions)
...
const scene1: DialogueSceneData = {
  ...
  scene_context: 'You are at a small cafe in Bali. A friendly local sits at the next table and greets you. You introduce yourselves and chat about where you are from.',
  sort_order: 1,
  dialogues: [
  ...
  existingWordTexts: ['selamat pagi', 'apa', 'baik', 'terima kasih', 'nama', 'saya'],
};
