...
const scene3_1: DialogueSceneData = {
  ...
  dialogues: [
    ...
    },
    {
      ...
      speaker: 'You',
      text_target: 'Si, por favor. ?Tiene el menu?',
      text_en: 'Yes, please. Do you have the menu?',
    },
    {
      id: 'e2000000-0019-4000-8000-000000000003',
      speaker: 'Camarero',
      text_target: 'Aqui tiene. Hoy tenemos sopa, pollo con arroz y ensalada.',
    ...
    },
    {
      ...
      speaker: 'Camarero',
      text_target: 'Muy bien. ?Y para beber? ?Agua o algo mas?',
      text_en: 'Very well. And to drink? Water or something else?',
    },
    {
      id: 'e2000000-0019-4000-8000-000000000006',
      speaker: 'You',
      text_target: 'Un agua, por favor. Y el plato del dia, ?que es?',
  ...
  newWords: [
    { id: 'b2000000-0001-4000-8000-000000000099', text: 'menu', meaning_en: 'menu', part_of_speech: 'noun' },
...
const scene3_2: DialogueSceneData = {
  ...
  dialogues: [
    ...
    },
    {
      ...
      speaker: 'You',
      text_target: '!Si! Quiero un taco con pollo, por favor. ?Es picante?',
  ...
  phrases: [
    ...
    },
    {
      ...
      text_target: 'Otro mas',
      text_en: 'Another one / one more',
      literal_translation: 'Other more',
      usage_note:
        'Use "otro" to ask for another of the same thing. "Mas" means more.',
      wordTexts: ['otro', 'mas'],
    },
    {
  ...
  patterns: [
    ...
    },
    {
      ...
      correct_answer: 'rico',
      distractors: ['picante', 'frio', 'caliente'],
    },
    {
  ...
  newWords: [
    ...
    { id: 'b2000000-0001-4000-8000-000000000117', text: 'mas', meaning_en: 'more', part_of_speech: 'adverb' },
    ...
    { id: 'b2000000-0001-4000-8000-000000000120', text: 'frio', meaning_en: 'cold', part_of_speech: 'adjective' },
  ],
  existingWordTexts: [
...
const scene3_3: DialogueSceneData = {
  ...
  dialogues: [
    ...
    },
    {
      ...
      speaker: 'Vendedora',
      text_target: 'Si, la verdura esta fresca y barata. ?Quiere algo mas?',
  ...
  patterns: [
    {
      ...
      pattern_template: '?Cuanto cuesta un ___ de mangos?',
      ...
      prompt: '?Cuanto cuesta un ___ de mangos?',
    ...
    },
    {
      ...
      pattern_template: '?Quiere ___ mas?',
      pattern_en: 'Do you want something else?',
      explanation:
        '"Algo" means "something." Use "algo mas" to ask about anything else.',
      prompt: '?Quiere ___ mas?',
...
// ── Scene 3.4: En el cafe (At a Coffee Shop) ─────────────────────────
...
const scene3_4: DialogueSceneData = {
  ...
  scene_context:
    'You stop at a cozy cafe for an afternoon break. You order coffee and chat with the barista about drink options. Practice ordering hot and cold drinks and customizing your order.',
  sort_order: 12,
  dialogues: [
    {
      id: 'e2000000-0022-4000-8000-000000000001',
      speaker: 'Barista',
      text_target: '!Buenas tardes! ?Que quiere tomar?',
      text_en: 'Good afternoon! What would you like to have?',
    },
    {
      id: 'e2000000-0022-4000-8000-000000000002',
      speaker: 'You',
      text_target: 'Un cafe con leche, por favor. ?Lo tiene caliente?',
      text_en: 'A coffee with milk, please. Do you have it hot?',
    },
    {
      id: 'e2000000-0022-4000-8000-000000000003',
      speaker: 'Barista',
      text_target: '!Claro! ?Quiere azucar? Tambien tenemos cafe helado.',
      text_en: 'Of course! Do you want sugar? We also have iced coffee.',
    },
    {
      id: 'e2000000-0022-4000-8000-000000000004',
      speaker: 'You',
      text_target: 'Sin azucar, gracias. ?El cafe helado es dulce?',
      text_en: 'Without sugar, thanks. Is the iced coffee sweet?',
    },
    {
      id: 'e2000000-0022-4000-8000-000000000005',
      speaker: 'Barista',
      text_target: 'Un poco dulce. ?Quiere una taza grande o pequena?',
      text_en: 'A little sweet. Do you want a large or small cup?',
    },
    {
      id: 'e2000000-0022-4000-8000-000000000006',
      speaker: 'You',
      text_target: 'Una taza grande, por favor. ?Tiene un cafe solo tambien?',
  ...
  patterns: [
    ...
    },
    {
      ...
      pattern_template: '?Quiere una taza ___ o pequena?',
      pattern_en: 'Do you want a large or small cup?',
      explanation:
        '"Grande" means "large." "Pequena" means "small." Use with "o" (or) to offer a choice.',
      prompt: '?Quiere una taza ___ o pequena?',
  ...
  newWords: [
    { id: 'b2000000-0001-4000-8000-000000000131', text: 'cafe', meaning_en: 'coffee / cafe', part_of_speech: 'noun' },
    { id: 'b2000000-0001-4000-8000-000000000132', text: 'leche', meaning_en: 'milk', part_of_speech: 'noun' },
    { id: 'b2000000-0001-4000-8000-000000000133', text: 'azucar', meaning_en: 'sugar', part_of_speech: 'noun' },
