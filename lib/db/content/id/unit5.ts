...
const scene5_1a: DialogueSceneData = {
  id: 'd1000000-0001-4000-8000-000000000025',
  title: 'Lihat Vila (House Tour)',
  description: 'Viewing a rental property, rooms and amenities',
  scene_context:
    'You are viewing a villa to rent in Ubud. The owner shows you each room and the outdoor space. Practice housing vocabulary and room descriptions.',
  sort_order: 33,
  dialogues: [
    {
      id: 'e1000000-0025-4000-8000-000000000001',
      speaker: 'Pemilik',
      text_target: 'Selamat pagi! Mau lihat vila ini? Ada dua kamar besar.',
      text_en: 'Good morning! Want to see this villa? There are two big bedrooms.',
    },
    {
      id: 'e1000000-0025-4000-8000-000000000002',
      speaker: 'You',
      text_target: 'Bagus! Ada kamar mandi berapa?',
      text_en: 'Nice! How many bathrooms are there?',
    },
    {
      id: 'e1000000-0025-4000-8000-000000000003',
      speaker: 'Pemilik',
      text_target: 'Satu kamar mandi dengan dapur besar. Ini dapurnya.',
      text_en: 'One bathroom with a big kitchen. This is the kitchen.',
    },
    {
      id: 'e1000000-0025-4000-8000-000000000004',
      speaker: 'You',
      text_target: 'Dapur ini bagus sekali! Ada taman?',
      text_en: 'This kitchen is very nice! Is there a garden?',
    },
    {
      id: 'e1000000-0025-4000-8000-000000000005',
      speaker: 'Pemilik',
      text_target: 'Ada taman besar dan kolam juga. Mau sewa?',
      text_en: 'There is a big garden and a pool too. Want to rent?',
    },
    {
      id: 'e1000000-0025-4000-8000-000000000006',
      speaker: 'You',
      text_target: 'Saya suka vila ini! Kos di sini mahal?',
      text_en: 'I like this villa! Is a boarding room here expensive?',
    },
  ],
  phrases: [
    {
    ...
    },
    {
      ...
      text_target: 'Kamar mandi di mana?',
      text_en: 'Where is the bathroom?',
      literal_translation: 'Room bathe at where?',
      usage_note:
        '"Kamar mandi" literally means "bathing room". Two-word nouns are common in Indonesian.',
      wordTexts: ['kamar mandi'],
    },
    {
      id: 'f1000000-0025-4000-8000-000000000004',
      text_target: 'Ada taman dan dapur',
      text_en: 'There is a garden and a kitchen',
      literal_translation: 'There-is garden and kitchen',
      usage_note:
        'List amenities with "ada" + noun + "dan" (and) + noun. Simple and natural.',
      wordTexts: ['ada', 'taman', 'dapur'],
    },
  ],
  patterns: [
    {
    ...
    },
    {
      ...
      pattern_template: 'Mau sewa ___',
      pattern_en: 'Want to rent ___',
      explanation:
        '"Mau" + verb + noun expresses intention. "Mau sewa vila" = want to rent a villa.',
      prompt: 'Mau ___ vila?',
      hint_en: 'Want to rent a villa?',
      correct_answer: 'sewa',
      distractors: ['beli', 'lihat', 'ada'],
    },
    {
      id: '0a000000-0025-4000-8000-000000000003',
      pattern_template: 'Ada ___ dan ___',
      pattern_en: 'There is ___ and ___',
      explanation:
        'Use "ada" to list things that exist in a place. Connect items with "dan" (and).',
      prompt: 'Ada taman dan ___.',
      hint_en: 'There is a garden and a pool.',
      correct_answer: 'kolam',
      distractors: ['dapur', 'kamar', 'vila'],
    },
  ],
  newWords: [
  ...
  existingWordTexts: [
    'rumah', 'ada', 'kamar', 'besar', 'kecil', 'bagus', 'berapa', 'mau',
    'saya', 'ini', 'dua', 'satu', 'lantai', 'dengan',
  ],
};

// ── Scene 5.1b: Harga Sewa (Rental Terms) ───────────────────────────

const scene5_1b: DialogueSceneData = {
  id: 'd1000000-0001-4000-8000-000000000045',
  title: 'Harga Sewa (Rental Terms)',
  description: 'Negotiating rent, what is included',
  scene_context:
    'You liked the villa and now discuss the rental price with the owner. Practice negotiating rent and asking what is included.',
  sort_order: 34,
  dialogues: [
    {
      id: 'e1000000-0045-4000-8000-000000000001',
      speaker: 'You',
      text_target: 'Berapa harga sewa per bulan?',
      text_en: 'How much is the rent per month?',
    },
    {
      id: 'e1000000-0045-4000-8000-000000000002',
      speaker: 'Pemilik',
      text_target: 'Tujuh juta per bulan. Termasuk wifi.',
      text_en: 'Seven million per month. Including wifi.',
    },
    {
      id: 'e1000000-0045-4000-8000-000000000003',
      speaker: 'You',
      text_target: 'Termasuk AC? Itu mahal. Bisa kurang?',
      text_en: 'Including AC? That is expensive. Can you lower it?',
    },
    {
      id: 'e1000000-0045-4000-8000-000000000004',
      speaker: 'Pemilik',
      text_target: 'AC tidak termasuk, tapi wifi termasuk. Sewa per tahun lebih murah.',
      text_en: 'AC is not included, but wifi is included. Renting per year is cheaper.',
    },
    {
      id: 'e1000000-0045-4000-8000-000000000005',
      speaker: 'You',
      text_target: 'Berapa per tahun? Saya mau sewa satu tahun.',
      text_en: 'How much per year? I want to rent for one year.',
    },
    {
      id: 'e1000000-0045-4000-8000-000000000006',
      speaker: 'Pemilik',
      text_target: 'Tujuh puluh juta per tahun, termasuk wifi dan AC. Dua kamar dengan dapur.',
      text_en: 'Seventy million per year, including wifi and AC. Two bedrooms with a kitchen.',
    },
  ],
  phrases: [
    {
      id: 'f1000000-0045-4000-8000-000000000001',
    ...
    {
      id: 'f1000000-0045-4000-8000-000000000002',
    ...
    {
      id: 'f1000000-0045-4000-8000-000000000003',
      text_target: 'Sewa per tahun',
      text_en: 'Rent per year',
      literal_translation: 'Rent per year',
      usage_note:
        '"Per tahun" means yearly. Yearly rent is often cheaper than monthly in Bali.',
      wordTexts: ['sewa', 'per', 'tahun'],
    },
    {
      id: 'f1000000-0045-4000-8000-000000000004',
      text_target: 'AC tidak termasuk',
      text_en: 'AC is not included',
      literal_translation: 'AC not including',
      usage_note:
        '"Tidak termasuk" means "not included". Use this to clarify what is and is not in the price.',
      wordTexts: ['AC', 'termasuk'],
    },
  ],
  patterns: [
    {
      id: '0a000000-0045-4000-8000-000000000001',
    ...
    {
      id: '0a000000-0045-4000-8000-000000000002',
    ...
    {
      id: '0a000000-0045-4000-8000-000000000003',
      pattern_template: 'Sewa per ___ lebih murah',
      pattern_en: 'Renting per ___ is cheaper',
      explanation:
        'Use "per" + time period + "lebih murah" to compare rental options. Longer terms are usually cheaper.',
      prompt: 'Sewa per ___ lebih murah.',
      hint_en: 'Renting per year is cheaper.',
      correct_answer: 'tahun',
      distractors: ['bulan', 'hari', 'minggu'],
    },
  ],
  newWords: [
  ...
  existingWordTexts: [
    'berapa', 'harga', 'mahal', 'murah', 'bisa', 'mau', 'saya', 'tidak',
    'tapi', 'juta', 'satu', 'dua', 'tiga', 'sewa', 'vila', 'kamar', 'dengan',
  ],
};

// ── Scene 5.2a: Pagi Hari (Morning Activities) ──────────────────────

const scene5_2a: DialogueSceneData = {
  id: 'd1000000-0001-4000-8000-000000000026',
  title: 'Pagi Hari (Morning Activities)',
  description: 'Morning routine activities',
  scene_context:
    'You and your neighbor Wayan chat about your morning routines. Practice daily activity verbs and morning habits.',
  sort_order: 35,
  dialogues: [
    {
    ...
    },
    {
      ...
      speaker: 'You',
      text_target: 'Belum. Saya bangun jam delapan. Mandi dulu, baru makan.',
      text_en: 'Not yet. I woke up at eight. Shower first, then eat.',
    },
    {
      id: 'e1000000-0026-4000-8000-000000000003',
      speaker: 'Wayan',
      text_target: 'Saya bangun jam enam setiap pagi. Mandi, minum kopi.',
      text_en: 'I wake up at six every morning. Shower, drink coffee.',
    },
    {
      id: 'e1000000-0026-4000-8000-000000000004',
      speaker: 'You',
      text_target: 'Saya belajar bahasa Indonesia setiap pagi. Tidur jam berapa?',
      text_en: 'I study Indonesian every morning. What time do you sleep?',
    },
    {
      id: 'e1000000-0026-4000-8000-000000000005',
      speaker: 'Wayan',
      text_target: 'Bekerja sampai siang, tidur jam sepuluh. Setiap hari sama.',
      text_en: 'Work until noon, sleep at ten. Every day the same.',
    },
  ],
  phrases: [
    {
    ...
    },
    {
      ...
      text_target: 'Mandi dulu',
      text_en: 'Shower first',
      literal_translation: 'Bathe first',
      usage_note:
        '"Mandi" means to bathe or shower. "Dulu" means "first" when placed after a verb.',
      wordTexts: ['mandi'],
    },
    {
      id: 'f1000000-0026-4000-8000-000000000003',
      text_target: 'Belajar setiap pagi',
      text_en: 'Study every morning',
      literal_translation: 'Study every morning',
      usage_note:
        '"Belajar" means "to study" or "to learn". Combine with "setiap" + time for habits.',
      wordTexts: ['belajar', 'setiap'],
    },
    {
  ...
  patterns: [
    ...
    },
    {
      ...
      pattern_template: '___ setiap pagi',
      pattern_en: '___ every morning',
      explanation:
        'Verb + "setiap pagi" describes a morning habit. "Setiap" means "every".',
      prompt: '___ setiap pagi.',
      hint_en: 'Study every morning.',
      correct_answer: 'Belajar',
      distractors: ['Bangun', 'Mandi', 'Tidur'],
    },
    {
      id: '0a000000-0026-4000-8000-000000000003',
      pattern_template: 'Tidur jam ___',
      pattern_en: 'Sleep at ___',
      explanation:
        '"Tidur jam" + number tells what time you go to sleep. Same structure as "bangun jam".',
      prompt: 'Tidur jam ___.',
      hint_en: 'Sleep at ten.',
      correct_answer: 'sepuluh',
      distractors: ['delapan', 'enam', 'sembilan'],
    },
  ],
  newWords: [
  ...
  existingWordTexts: [
    'pagi', 'saya', 'jam', 'berapa', 'makan', 'minum', 'kopi', 'sudah',
    'belum', 'enam', 'delapan', 'di mana',
  ],
};

// ── Scene 5.2b: Kata Waktu (Time Words) ─────────────────────────────

const scene5_2b: DialogueSceneData = {
  id: 'd1000000-0001-4000-8000-000000000046',
  title: 'Kata Waktu (Time Words)',
  description: 'Days, time references, habits',
  scene_context:
    'You continue chatting with Wayan about his weekly schedule. Practice days of the week, time references, and describing habits.',
  sort_order: 36,
  dialogues: [
    {
      id: 'e1000000-0046-4000-8000-000000000001',
      speaker: 'You',
      text_target: 'Bekerja setiap hari? Kemarin juga bekerja?',
      text_en: 'Work every day? Yesterday too?',
    },
    {
      id: 'e1000000-0046-4000-8000-000000000002',
      speaker: 'Wayan',
      text_target: 'Kemarin libur. Besok kerja lagi. Biasanya enam hari kerja.',
      text_en: 'Yesterday was off. Tomorrow work again. Usually six work days.',
    },
    {
      id: 'e1000000-0046-4000-8000-000000000003',
      speaker: 'You',
      text_target: 'Hari Minggu libur? Saya biasanya belajar hari Minggu.',
      text_en: 'Sunday off? I usually study on Sundays.',
    },
    {
      id: 'e1000000-0046-4000-8000-000000000004',
      speaker: 'Wayan',
      text_target: 'Ya, hari Minggu libur. Besok hari apa?',
      text_en: 'Yes, Sunday is off. What day is tomorrow?',
    },
    {
      id: 'e1000000-0046-4000-8000-000000000005',
      speaker: 'You',
      text_target: 'Besok hari Senin. Saya biasanya bangun jam enam hari kerja.',
      text_en: 'Tomorrow is Monday. I usually wake up at six on work days.',
    },
    {
      id: 'e1000000-0046-4000-8000-000000000006',
      speaker: 'Wayan',
      text_target: 'Saya juga! Mandi, makan, lagi kerja. Setiap minggu sama.',
      text_en: 'Me too! Shower, eat, then work. Every week the same.',
    },
  ],
  phrases: [
    {
      id: 'f1000000-0046-4000-8000-000000000001',
    ...
    {
      id: 'f1000000-0046-4000-8000-000000000002',
      text_target: 'Kemarin libur',
      text_en: 'Yesterday was a day off',
      literal_translation: 'Yesterday off',
      usage_note:
        '"Kemarin" means "yesterday". No verb "to be" needed — just place the adjective after.',
      wordTexts: ['kemarin'],
    },
    {
      id: 'f1000000-0046-4000-8000-000000000003',
    ...
    {
      id: 'f1000000-0046-4000-8000-000000000004',
      text_target: 'Besok kerja lagi',
      text_en: 'Tomorrow work again',
      literal_translation: 'Tomorrow work again',
      usage_note:
        '"Besok" means "tomorrow". "Kerja" is the informal root of "bekerja" (to work). "Lagi" means "again".',
      wordTexts: ['besok', 'kerja', 'lagi'],
    },
  ],
  patterns: [
    {
      id: '0a000000-0046-4000-8000-000000000001',
      pattern_template: 'Setiap ___',
      pattern_en: 'Every ___',
      explanation:
        '"Setiap" + time word expresses regular habits. "Setiap hari" = every day, "setiap minggu" = every week.',
      prompt: '___ hari.',
      hint_en: 'Every day.',
    ...
    {
      id: '0a000000-0046-4000-8000-000000000002',
      ...
      prompt: '___ bangun jam enam.',
      hint_en: 'Usually wake up at six.',
      correct_answer: 'Biasanya',
      distractors: ['Setiap', 'Kemarin', 'Besok'],
    },
    {
      id: '0a000000-0046-4000-8000-000000000003',
      pattern_template: 'Kemarin ___, besok ___',
      pattern_en: 'Yesterday ___, tomorrow ___',
      explanation:
        'Use "kemarin" for past and "besok" for future. Indonesian does not change the verb form for tense.',
      prompt: '___ libur, besok kerja.',
      hint_en: 'Yesterday off, tomorrow work.',
      correct_answer: 'Kemarin',
      distractors: ['Biasanya', 'Setiap', 'Sekarang'],
    },
  ],
  newWords: [
  ...
  existingWordTexts: [
    'saya', 'jam', 'berapa', 'sudah', 'belum', 'sekarang', 'siang',
    'restoran', 'dekat', 'lagi', 'bangun', 'mandi', 'bekerja', 'belajar',
    'setiap',
  ],
};
...
export const UNIT5_SCENES: DialogueSceneData[] = [scene5_1a, scene5_1b, scene5_2a, scene5_2b, scene5_3, scene5_4, scene5_5];
