...
export { playWordPronunciation, playAudioDirect, stopPlayback, getPlaybackSpeed, setPlaybackSpeed, isAudioUnlocked, onAudioUnlocked, attachAudioUnlockListener, preloadAudioUrls } from './pronunciation';
