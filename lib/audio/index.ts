...
export { playWordPronunciation, playAudioDirect, stopPlayback, getPlaybackSpeed, setPlaybackSpeed, isAudioUnlocked, attachAudioUnlockListener } from './pronunciation';
