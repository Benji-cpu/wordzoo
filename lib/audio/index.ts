...
export { playWordPronunciation, playAudioDirect, stopPlayback, getPlaybackSpeed, setPlaybackSpeed, isAudioUnlocked, onAudioUnlocked, attachAudioUnlockListener } from './pronunciation';
