  ...
  return (
    <Card className="animate-slide-up overflow-hidden" onClick={onContinue}>
      ...
      <div className="flex items-center gap-1 whitespace-nowrap overflow-hidden mb-1">
        <span className="text-[clamp(0.8rem,3.8vw,1.125rem)] font-bold text-accent-id">{wordText}</span>
        {wordId && (
        ...
        {keyword && (
          <>
            <span className="text-[clamp(0.8rem,3.8vw,1.125rem)] text-foreground">sounds like</span>
            <span className="text-[clamp(0.8rem,3.8vw,1.125rem)] font-bold text-foreground">&ldquo;{keyword}&rdquo;</span>
          </>
        )}
      </div>
