  ...
  return (
    <div className="max-w-4xl mx-auto pb-24">
      <div className="flex items-center gap-2 mb-6 overflow-x-auto">
        ...
        <Link href="/admin/pedagogy" className="text-sm font-medium text-text-secondary hover:text-foreground transition-colors px-3 py-1.5 rounded-lg hover:bg-surface-inset">
          Pedagogy
        </Link>
